...
|                                                              آدرس هاستی که مرزگشا روی آن اجرا میشود (پیشفرض: `0.0.0.0`) |                                                      UVICORN_HOST                                                       |
|                                                                      پورتی که مرزگشا روی آن اجرا میشود (پیشفرض: `8000`) |                                                      UVICORN_PORT                                                       |
|                                                                               اجرای مرزگشا بر روی یک Unix domain socket |                                                       UVICORN_UDS                                                       |
|                                                                              آدرس گواهی SSL به جهت ایمن کردن پنل مرزگشا |                                                  UVICORN_SSL_CERTFILE                                                   |
...
|                            مدت زمان انقضا توکن دسترسی به پنل مرزگشا, `0` به معنای بدون تاریخ انقضا است (پیشفرض: `1440`) |                                             JWT_ACCESS_TOKEN_EXPIRE_MINUTES                                             |
